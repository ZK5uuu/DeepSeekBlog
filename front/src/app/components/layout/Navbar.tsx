...
const navigation = [
  ...
  { name: '我的博客', href: '/music', icon: <FaMusic className="mr-2" /> },
];
    ...
    >
      <div className="container-custom py-4">
        <div className="flex justify-between items-center">
          {/* 网站标志 */}
          <Link href="/home" onClick={handleNavigationClick}>
            <motion.div 
                    ...
                    <div className="py-1" role="menu" aria-orientation="vertical">
                      <Link href="/blog/create?type=music" onClick={() => setIsCreateOpen(false)}>
                        ...
                        >
                          ...
                          <div>
                            <p className="font-medium">创建博客</p>
                            <p className="text-xs text-gray-500 dark:text-gray-400">分享你的想法和感悟</p>
                          </div>
                        </motion.div>
                      </Link>
                    </div>
              ...
              <div className="bg-gray-50 dark:bg-gray-800/60 rounded-xl overflow-hidden">
                <Link href="/blog/create?type=music" onClick={() => setIsOpen(false)}>
                  ...
                  >
                    ...
                    <div>
                      <p className="font-medium text-gray-800 dark:text-gray-200">创建博客</p>
                      <p className="text-xs text-gray-500 dark:text-gray-400">分享你的想法和感悟</p>
                    </div>
                  </motion.div>
                </Link>
